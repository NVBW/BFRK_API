...
public class toilette extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("dhid") != null) {
			...
			if(requesturi.indexOf("/toilette") != -1) {
		...
		try {
			...
			while(selectMerkmaleRS.next()) {
				...
				if(name.equals("OBJ_Toilette_Rollstuhltauglich"))
					merkmaleJsonObject.put("rollstuhltauglich", wert);
				else if(name.equals("OBJ_Toilette_Lokalschluessel_Notiz"))
					merkmaleJsonObject.put("lokalschluesselnotiz", wert);
				else if(name.equals("OBJ_Toilette_Oeffnungszeiten_Beschreibung_D1075"))
					merkmaleJsonObject.put("oeffnungszeitenbeschreibung", wert);

				else if(name.equals("OBJ_Toilette_Foto"))
					merkmaleJsonObject.put("objekt_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Toilette_LokalerSchluessel_Foto"))
					merkmaleJsonObject.put("lokalerschluessel_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Toilette_Nutzungsbedingungen_Foto"))
					merkmaleJsonObject.put("nutzungsbedingungen_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Toilette_Oeffnungszeiten_Foto"))
					merkmaleJsonObject.put("oeffnungszeiten_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Toilette_Umgebung1_Foto"))
					merkmaleJsonObject.put("umgebung1_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Toilette_Umgebung2_Foto"))
