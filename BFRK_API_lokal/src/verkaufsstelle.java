...
public class verkaufsstelle extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("dhid") != null) {
			...
			if(requesturi.indexOf("/verkaufsstelle") != -1) {
...
//		String selectHaltestelleSql = "SELECT * FROM merkmal_view WHERE objekt_id = ?;";
		...
		try {
			...
			while(selectMerkmaleRS.next()) {
				...
				if(name.equals("OBJ_Verkaufsstelle_Art_D1021"))
					merkmaleJsonObject.put("verkaufsstellenart", wert);
				else if(name.equals("OBJ_Verkaufsstelle_stufenfrei_D1022"))
					merkmaleJsonObject.put("stufenfrei", wert.equals("true"));
				else if(name.equals("OBJ_Verkaufsstelle_Vorhanden_D1020")) {
					//nichts zu tun
				}
				else if(name.equals("OBJ_Verkaufsstelle_Foto"))
					merkmaleJsonObject.put("objekt_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Verkaufsstelle_EingangzuVerkaufsstelle_Foto"))
					merkmaleJsonObject.put("eingang_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Verkaufsstelle_Oeffnungszeiten_Foto"))
					merkmaleJsonObject.put("oeffnungszeiten_Foto", Bild.getBildUrl(wert, dhid));
				else if(name.equals("OBJ_Verkaufsstelle_WegzuVerkaufsstelle_Foto"))
